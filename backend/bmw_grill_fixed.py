#!/usr/bin/env python3
"""
BMW grill script with embedded MongoDB (like app.py) but with intelligent BMW tagging
"""
import os
import re
import threading
...
# Load environment (but use embedded MongoDB like app.py)
load_dotenv()
...
# FiftyOne dataset (embedded MongoDB like app.py)
...
# Load BMW images if not already loaded
if not is_loaded:
...
# Launch FiftyOne (same as app.py)
def start_fiftyone():
...
def get_stats():
    try:
        ...
        return jsonify({
            ...
            "fiftyone_url": "http://127.0.0.1:5151"
        })
...
if __name__ == "__main__":
    print("🚀 Starting BMW Grill Dataset Server with Intelligent Tagging")
    print("📊 FiftyOne UI: http://127.0.0.1:5151") 
    print("🔧 Flask API: http://127.0.0.1:5000")
    print("🏷️ Tag Analysis: http://127.0.0.1:5000/bmw/tags/analysis")
